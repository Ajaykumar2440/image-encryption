...
int main()
{
  ...
  imwrite("Image/keyspace_sensitivity/diff_perm_1.jpg",encImage1);
  imshow("Encrypted test image 1", encImage1);
  waitKey(0);

  imwrite("Image/keyspace_sensitivity/diff_perm_2.jpg",encImage2);
  imshow("Encrypted test image 2", encImage2);
  waitKey(0);


  imwrite("Image/keyspace_sensitivity/difference_diff_perm.jpg",diffImage);
